...
class ddShipmentDetails extends StatefulWidget {
  ddShipmentDetails({Key? key}) : super(key: key);

  @override
  State<ddShipmentDetails> createState() => _ddShipmentDetailsState();
}

class _ddShipmentDetailsState extends State<ddShipmentDetails> {
