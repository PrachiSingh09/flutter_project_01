...
class ddShipmentDetailsSeller extends StatefulWidget {
  ddShipmentDetailsSeller({Key? key}) : super(key: key);

  @override
  State<ddShipmentDetailsSeller> createState() =>
      _ddShipmentDetailsSellerState();
}

class _ddShipmentDetailsSellerState extends State<ddShipmentDetailsSeller> {
