...
class ddParcelDetails extends StatefulWidget {
  ddParcelDetails({Key? key}) : super(key: key);

  @override
  State<ddParcelDetails> createState() => _ddParcelDetailsState();
}

class _ddParcelDetailsState extends State<ddParcelDetails> {
