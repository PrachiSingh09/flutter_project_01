...
class SellerFind extends StatefulWidget {
  SellerFind({Key? key}) : super(key: key);

  @override
  State<SellerFind> createState() => _SellerFindState();
}

class _SellerFindState extends State<SellerFind> {
